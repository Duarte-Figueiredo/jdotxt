...
public class CursorPositionCalculatorTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {-1, null, null, 0},
                {-1, null, EMPTY_STRING, 0},
                {-1, null, BLANK_STRING, 5},
                {-1, null, SOME_VALUE, 10},
                {-1, EMPTY_STRING, null, 0},
                {-1, EMPTY_STRING, EMPTY_STRING, 0},
                {-1, EMPTY_STRING, BLANK_STRING, 4},
                {-1, EMPTY_STRING, SOME_VALUE, 9},
                {-1, BLANK_STRING, null, 0},
                {-1, BLANK_STRING, EMPTY_STRING, 0},
                {-1, BLANK_STRING, BLANK_STRING, 0},
                {-1, BLANK_STRING, SOME_VALUE, 4},
                {-1, SOME_VALUE, null, 0},
                {-1, SOME_VALUE, EMPTY_STRING, 0},
                {-1, SOME_VALUE, BLANK_STRING, 0},
                {-1, SOME_VALUE, SOME_VALUE, 0},
                {0, null, null, 0},
